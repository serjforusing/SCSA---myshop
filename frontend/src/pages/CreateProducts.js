    ...
    return(
        <main className="form-page">
            ...
            <form className="product-form" onSubmit={handleSubmit}>
                ...
                <label className="field-wide image-field" htmlFor="product-image"><span>პროდუქტის სურათი <small>არასავალდებულო</small></span><input id="product-image" type="file" accept="image/*" onChange={(e) => setImage(e.target.files[0] || null)} /></label>
